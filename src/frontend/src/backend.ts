...
export class Backend implements backendInterface {
    ...
    async addContactRequest(arg0: Contact): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.addContactRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addMovementQuote(arg0: MovementQuote): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.addMovementQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactRequests(): Promise<Array<Contact>> {
        if (this.processError) {
            try {
    ...
    async getMovementQuotes(): Promise<Array<MovementQuote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMovementQuotes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
